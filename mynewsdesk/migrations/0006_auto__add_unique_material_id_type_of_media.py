...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Material', fields ['id', 'type_of_media']
        db.create_unique('mynewsdesk_material', ['id', 'type_of_media'])


    def backwards(self, orm):
        # Removing unique constraint on 'Material', fields ['id', 'type_of_media']
        db.delete_unique('mynewsdesk_material', ['id', 'type_of_media'])
    ...
    models = {
        ...
        'mynewsdesk.material': {
            'Meta': {'unique_together': "(('id', 'type_of_media'),)", 'object_name': 'Material'},
